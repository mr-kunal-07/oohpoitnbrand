...
import { Users, ChevronDown, UserPen, LogOut, Menu } from "lucide-react";
...
const Header = ({ onMenuClick }) => {
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-slate-200 bg-white/95 backdrop-blur-md shadow-sm">
      <div className="flex h-14 sm:h-16 items-center justify-between gap-2 sm:gap-4 px-3 sm:px-4 md:px-6 lg:px-8">
        ...
        <div className="hidden md:block min-w-0 flex-1">
          <h1 className="text-sm md:text-base font-semibold text-slate-900 truncate uppercase">
            {brandName}
          </h1>
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 ml-auto">
          ...
          <a
            ...
            className="hidden md:flex items-center gap-2 px-3 py-2 bg-white text-slate-600 hover:text-green-600 rounded-lg transition-colors border border-slate-200 hover:border-green-200 hover:bg-green-50 whitespace-nowrap"
          >
            ...
            <span className="hidden lg:inline text-sm font-medium">Support</span>
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="md:hidden flex items-center justify-center w-9 h-9 bg-white text-green-600 border border-green-200 rounded-lg flex-shrink-0"
          ...
          {/* Leads Button - Desktop */}
          <button
            onClick={() => router.push("/leads")}
            className="hidden sm:flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-medium text-sm shadow-sm hover:shadow-md transition-all whitespace-nowrap"
          >
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className="flex items-center gap-1.5 sm:gap-2 px-1 sm:px-2 py-1 rounded-lg hover:bg-slate-100 transition-colors"
            >
              {/* Avatar */}
              ...
              <div className="hidden lg:flex flex-col items-start min-w-0">
                ...
                <p className="text-xs text-slate-500 truncate max-w-[120px] xl:max-w-[140px]">
                  {userEmail}
                </p>
              </div>
            ...
            {/* Dropdown Menu */}
            {showProfileMenu && (
              <div className="absolute right-0 top-full mt-2 w-64 sm:w-72 bg-white rounded-lg shadow-lg border border-slate-200 overflow-hidden animate-slideDown">
