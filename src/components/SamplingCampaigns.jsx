...
import { Loader2, ArrowUp, ArrowDown, BarChart3, Calendar } from "lucide-react";
...
const SamplingCampaigns = ({ campaigns = [] }) => {
        ...
        cell: ({ row }) => (
          <div className="flex justify-center">
            <button
              type="button"
              onClick={() =>
                router.push(`/dashboard/sampling/sampling-details?campaignId=${row.original.id}`)
              }
...
export default SamplingCampaigns;